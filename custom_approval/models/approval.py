...
class ApprovalRequest(models.Model):
    _name = 'x.custom.approval.request'
    _description = 'Custom Approval Request'
    ...
    def create(self, vals):
        if vals.get('name', _('New')) == _('New'):
            vals['name'] = self.env['ir.sequence'].next_by_code('custom.approval.request') or _('New')
    ...
    def _send_approval_email(self):
        template = self.env.ref('custom_approval.email_template_approval')
